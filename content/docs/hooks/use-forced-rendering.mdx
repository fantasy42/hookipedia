...
<Callout type="warning" title="Use as a Last Resort">
  Forcing a re-render is an <b>imperative escape hatch</b>. If you find yourself using this frequently, consider if the data should actually be stored in <code>useState</code> or <code>useReducer</code>.
</Callout>
